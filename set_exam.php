				...
				<div class="content">
					...
					<?php
						if(isset($_POST["submit"]))
						{
							...
							$sq="insert into exam(ENAME,ETYPE,EDATE,SESSION,DEPT,SUB) values ('{$_POST["ename"]}','{$_POST["etype"]}','{$edate}','{$_POST["ses"]}','{$_POST["cla"]}','{$_POST["sub"]}')";
							if($db->query($sq))
							{
					...
					<div class="lbox">
						...
						<label> Select type</label><br>
							<select name="etype" required class="input3">
						       ...
						       <option value="CCET-I">CCET-I</option>
						       <option value="CCET-II">CCET-II</option>
                               <option value="CCET-III">CCET-III</option>
